...
const ScrapperSettings = require("./ScrapperSettings");
...
class Settings {
	 ...
	 * @param {Object} settings.scrapper	Settings for the RSS Scrapper. See the constructor of {@link ScrapperSettings}
	...
	constructor(settings) {
		...
		/**
		 * The settings for the RSS Scrapper
		 *
		 * @type {ScrapperSettings}
		 */
		 this.scrapper = new ScrapperSettings(settings.scrapper);
	...
	static get DEFAULTS() {
		return {
			...
			scrapper: ScrapperSettings.DEFAULTS,
			bridges: [],
			debug: false
		};
	}
